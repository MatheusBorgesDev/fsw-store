        ...
        <AccordionItem value={order.id}>
          <AccordionTrigger>
            <div className="flex flex-col gap-1 text-left">
              <p>Pedido com {order.orderProducts.length}{" "}
              {order.orderProducts.length !== 1 ? "produtos" : "produto"}</p>
              <span className="text-sm opacity-60">Feito em {format(order.createdAt, 'd/MM/yy')}</span>
            </div>
          </AccordionTrigger>
